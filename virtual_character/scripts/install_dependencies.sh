...
sudo pacman -S --noconfirm python-pip python-devel python-virtualenv
...
pip install pygame speechrecognition pyttsx3 tensorflow deepspeech mycroft unittest wave
